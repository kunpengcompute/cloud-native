...
.PHONY: kunpeng-tap-build-pcore-binding
kunpeng-tap-build-pcore-binding: ## Build the hardened ARM64 pcore binding plugin.
	$(MAKE) -f Makefile.kunpeng-tap build-pcore-binding
...
.PHONY: kunpeng-tap-pcore-binding-docker-build
kunpeng-tap-pcore-binding-docker-build: ## Build the hardened ARM64 pcore binding plugin image.
	$(MAKE) -f Makefile.kunpeng-tap pcore-binding-docker-build
