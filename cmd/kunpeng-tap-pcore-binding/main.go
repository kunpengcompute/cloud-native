...
import (
	...
	"kunpeng.huawei.com/kunpeng-cloud-computing/pkg/kunpeng-tap-pcore-binding/plugin"
...
func parseConfig() plugin.Config {
	...
	klog.InfoS("Using kunpeng tap pcore binding config", "nriSocketPath", cfg.SocketPath,
