...
import (
	...
	"kunpeng.huawei.com/kunpeng-cloud-computing/pkg/kunpeng-perf-monitor/collector"
)
...
func (h *handler) innerHandler(filters ...string) (http.Handler, error) {
	...
	r.MustRegister(versioncollector.NewCollector("kunpeng_performance_montor"))
...
func main() {
	...
	kingpin.Version(version.Print("kunpeng_performance_montor"))
	...
	if *metricsPath != "/" {
		landingConfig := web.LandingConfig{
			Name:        "Kunpeng Performance Montor",
			Description: "Performance Montoring Exporter for Kunpeng Server",
