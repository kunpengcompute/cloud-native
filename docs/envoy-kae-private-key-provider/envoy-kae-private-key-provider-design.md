...
![整体架构概览](../images/KAE_Overview.png)

#### 3.1.2 工厂和Provider模块

该模块负责与 Envoy 框架集成，提供私钥方法提供者功能。

![工厂和Provider模块](../images/KAE_Factory_Provider.png)

#### 3.1.3 硬件管理模块

该模块负责管理 KAE 硬件实例，包括单例管理器、Section 配置和硬件句柄。

![硬件管理模块](../images/KAE_Hardware_Management.png)

#### 3.1.4 操作上下文模块

该模块负责管理单个加密/解密操作的上下文和生命周期。

![操作上下文模块](../images/KAE_Operation_Context.png)

#### 3.1.5 UADK 接口模块

该模块封装了底层 UADK 库的调用，提供统一的接口抽象。

![UADK 接口模块](../images/KAE_UADK_Interface.png)

#### 3.1.6 模块间关系图

展示各模块之间的依赖和交互关系。

![模块间关系图](../images/KAE_Module_Relations.png)
### 3.2 详细类说明
...
![整体时序图](../images/KAE_Overall_Sequence.png)
...
![完整类图](../images/KAE_Complete_Class_Diagram.png)
