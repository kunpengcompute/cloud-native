...
func (m *MockInterface) CreateQemuKvmDevicesInfo() error {
	m.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) CreateQemuKvmDevicesInfo() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateQemuKvmDevicesInfo", reflect.TypeOf((*MockInterface)(nil).CreateQemuKvmDevicesInfo))
}

// CreateQemuKvmDevicesInfoFromNodeStatus mocks base method.
func (m *MockInterface) CreateQemuKvmDevicesInfoFromNodeStatus(arg0 *v1.SriovNetworkNodeState) {
	m.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) CreateQemuKvmDevicesInfoFromNodeStatus(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateQemuKvmDevicesInfoFromNodeStatus", reflect.TypeOf((*MockInterface)(nil).CreateQemuKvmDevicesInfoFromNodeStatus), arg0)
}
...
func (m *MockInterface) DiscoverSriovDevicesVirtualInQemuKvm() ([]v1.InterfaceExt, error) {
	m.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) DiscoverSriovDevicesVirtualInQemuKvm() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DiscoverSriovDevicesVirtualInQemuKvm", reflect.TypeOf((*MockInterface)(nil).DiscoverSriovDevicesVirtualInQemuKvm))
}
