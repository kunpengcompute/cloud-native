...
# assign VERSION_OVERRIDE manually
## Due to that sriov-network-operator is not a git repository anymore
## the cmds above to get VERSION_OVERRIDE will fail.
VERSION_OVERRIDE=v1.00-RC2-19-g1388017
