"""
kunpeng-tap Cluster 拓扑感知测试运行器

使用 pytest-bdd 运行 Cluster 拓扑感知测试场景
适用于 950 型号机器（4NUMA × 96核，每NUMA 12个Cluster）
每个测试超时: 120秒
"""
...
# 加载 Cluster 拓扑测试场景
# 包含 CL-01 到 CL-18 共 18 个测试
scenarios('features/cluster_topology_tests.feature')

# 为所有 Cluster 拓扑测试设置超时时间（120秒）
